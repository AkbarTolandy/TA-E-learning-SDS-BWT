...
<div class="container-fluid">
  ...
  <p class="mb-4">Materi untuk semua siswa.</p>
				...
				<div class="card mb-4 shadow">
				  <div class="card-body">
				  	<div class="row">
				  		<div class="col-sm">
					    	<div class="form-group">
						    	...
						    	<input type="text" placeholder="Pertemuan" id="bab" name="bab" class="form-control" value="<?=set_value('bab') ?>">				 
						    	<?=form_error('bab', '<small class="text-danger">', '</small>') ?>
					    	</div>
					    </div>
					    <div class="col-sm-9">
					    	<div class="form-group">
						    	<label for="title" class="text-primary">Judul Materi</label>
						    	<input type="text" placeholder="Judul Materi" id="title" name="title" class="form-control" value="<?=set_value('title') ?>">				 
				    ...
				    <div class="form-group">
				    	...
				    	<input type="text" readonly id="slug" name="slug" class="form-control" value="<?=set_value('slug') ?>">
				    </div>

				    <div class="form-group">
				    	<label for="precondition" class="text-primary">Prasyarat <?=form_error('precondition', '<small class="text-danger">', '</small>') ?></label>
				    	<textarea style="resize: none" name="precondition" cols="50" rows="3" id="precondition" class="form-control"><?=set_value('precondition') ?></textarea>
				    ...
				    <div class="form-group">
				    	...
				    	<textarea name="description" cols="50" rows="10" id="description" class="form-control"><?=set_value('description') ?></textarea>
				    </div>
			...
			<div class="col-sm-3">
				<div class="card mb-4 shadow">
		        	...
		        	<select name="pelajaran_id" class="form-control" id="pelajaran_id">
		        		...
		        		<option value="<?=$pj['id'] ?>" 
		        			<?= set_select('pelajaran_id', $pj['id'], FALSE) ?>><?=$pj['nama_pelajaran'] ?></option>
		        		<?php endforeach ?>
		        	</select>
	          ...
	          <h6 class="m-0 text-primary">Dokumen Materi</h6>
			        ...
			        <label for="created_at" class="text-primary">Tanggal Publish</label>
							<input type="text" class="form-control" id="datepicker" placeholder="YY-MM-DD HH:MM" name="created_at">
			      </div>

						<div class="form-group">
							<div class="custom-control custom-checkbox">
							  <input type="checkbox" class="custom-control-input" value="1" id="is_publish" name="is_publish" <?php echo set_checkbox('is_publish', '1') ?>>
